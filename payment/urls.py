...
urlpatterns = [
    ...
    path('donate', views.mpesaPaymentAPIView.as_view(), name='add-debit-card'),
    path('confirm/<str:transaction_id>/', views.mpesaConfirmPaymentAPIView.as_view(), name='confirm'),
